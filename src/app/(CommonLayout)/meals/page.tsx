...
import { PriceRange } from '@/components/modules/home/PriceRange';
...
export default async function MealsPage({searchParams}: {searchParams: TSearchParams}) {
  ...
  return (
    <section className="pt-16 pb-20 bg-fh-cream-mid">
      <div className="bg-fh-green-deep py-20 px-4 sm:px-8">
      ...
      <div className="container mx-auto px-4 xl:px-0 pt-20">
        <div className="flex sm:flex-row flex-col justify-between sm:items-center mb-10 sm:gap-0 gap-5">
